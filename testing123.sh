...
cd ~ && cd .minecraft/libraries/org/lwjgl/lwjgl/lwjgl && mkdir 2.9.2-nightly-20140822 \
...
cd ~ && cd .minecraft/libraries/org/lwjgl/lwjgl/lwjgl_util && mkdir 2.9.2-nightly-20140822 \
cd 2.9.2-nightly-20140822 && wget libraries.minecraft.net/org/lwjgl/lwjgl/lwjgl_util/2.9.2-nightly-20140822/lwjgl_util-2.9.2-nightly-20140822.jar
...
wget libraries.minecraft.net/com/mojang/text2speech/1.10.3/text2speech-1.10.3-natives-windows.jar && cd ~
